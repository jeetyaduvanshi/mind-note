...
const Banner = () => {
  return (
    <div className='px-4 py-20 bg-black mx-auto'>
      <div className='text-white text-center'>
        ...
        <div className='flex justify-center gap-4 flex-wrap'>
          ...
          <Link
            to="/create-post"
            className='font-medium bg-orange-500 hover:bg-white hover:text-orange-500 inline-flex items-center py-2 px-6 rounded-lg transition-all duration-300'
          >
